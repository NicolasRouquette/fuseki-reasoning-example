 ...
 */
public class OwlReasonIncrementallyJena2g {
    ...
    static final Logger LOGGER = LoggerFactory.getLogger("io.opencaesar.owl.fuseki_reasoner.OwlReasonIncrementallyJena2g");
    ...
    public static void main(String[] args) throws Exception {
        ...
        final OwlReasonIncrementallyJena2g app = new OwlReasonIncrementallyJena2g();
    ...
    public OwlReasonIncrementallyJena2g() {
        JenaSystem.init();
    }
